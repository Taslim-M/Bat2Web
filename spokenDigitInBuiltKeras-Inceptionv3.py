...
for file_name in file_paths:
    ...
    spectrogram = spectrogram.resize((299,299))
...
model = keras.applications.inception_v3.InceptionV3(include_top=True, weights=None, input_tensor=None, input_shape=None, pooling=None, classes=10)
